...
app.use(session({  
    secret: '72415', // Cambia esto a un valor seguro  
    resave: false,  
...
const connection = mysql.createConnection({  
    ...
    password: '112315',      // Contraseña del usuario  
    database: 'proyecto_web' // Nombre de la base de datos  
});  
        ...
        if (results.length > 0) {  
            ...
            bcrypt.compare(password, user.contraseña, (err, match) => {  
                ...
                if (match) { 
                    ...
                    console.log(nombre)
                    return res.redirect('/welcome'); // Redirigir a la página de bienvenida  
                } else {  
